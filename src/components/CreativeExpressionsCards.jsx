...
const CreativeExpressionsCards = ({ craft }) => {
    // console.log(craft)
    return (
        <div>
                ...
                <div className="card  bg-base-100 shadow-xl h-[500px]">
                    ...
                    <div className="card-body">
                        ...
                        <div className="card-actions mt-4">
                            <Link to={`/CreativeExpressions/${craft._id}`} className="btn btn-primary w-full hover:bg-secondary">Details</Link>
                        </div>
                    </div>
                </div>
...
export default CreativeExpressionsCards;