        ...
        <div >
            ...
            <div className="lg:flex hidden">
                <footer data-aos="fade-up" data-aos-duration="3000" className="footer p-10 bg-base-200 text-base-content ">
                    <aside>
                        ...
                        <p><span className="font-bold text-2xl">Canvas Crafts LTD.</span><br />Providing reliable tech since 1992</p>
                    </aside>
                    <nav>
            ...
            <div className="flex lg:hidden">
                <footer className="footer footer-center p-10 bg-base-200 " data-aos="fade-up" data-aos-duration="3000">
                    <aside>
                        ...
                        Canvas Crafts LTD. <br />Providing reliable tech since 1992
                        </p>
            ...
            <div className="lg:flex hidden">
                <div className="w-full " >
                    <p className='text-xs bg-base-200 py-2 text-center '>Copyright © 2024 - All right reserved by Evergreen Properties</p>
                </div>
            </div>
        </div>
    );
