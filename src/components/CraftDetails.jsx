            ...
            <div className="card bg-base-100  shadow-xl">
                ...
                <div className="card-body space-y-3">
                    ...
                    <div className="flex justify-between ">
                        {/* <Link to='/allart&craft' className="mt-5 btn rounded-xl bg-green-500 hover:bg-gradient-to-r hover:from-green-500 hover:to-green-400 text-white font-semibold hover:ring-2 hover:ring-offset-2 hover:ring-green-400 transition-all ease-out duration-300 w-full">Back To Previous Page</Link> */}
